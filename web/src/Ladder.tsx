    ...
    <div id="ladder" style={{ padding: '40px 44px 44px', borderTop: `1px solid ${LINE}`, background: PANEL, scrollMarginTop: 66 }}>
      <div style={{ marginBottom: 22 }}>
        ...
        <p style={{ margin: 0, font: '400 14.5px/1.6 Archivo,sans-serif', color: MUTED }}>
          ...
          wide bar means a volatile weekend. The caret marks expected points, gridlines mark the points
          scale, and the P10-P90 column gives the same range as numbers so close-run rows near the
          bottom can still be told apart. Your seven picks carry their team colours.
        </p>
      </div>
